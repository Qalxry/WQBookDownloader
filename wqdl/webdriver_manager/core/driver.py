...
from wqdl.webdriver_manager.core.config import gh_token
...
class Driver(object):
    ...
    def get_driver_version_to_download(self):
        ...
        """
        if self._driver_version_to_download is None or self._driver_version_to_download == "latest":
            self._driver_version_to_download = self.get_latest_release_version()
