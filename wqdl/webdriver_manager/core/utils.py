...
def windows_browser_apps_to_cmd(*apps: str) -> str:
    ...
    # NOTE: Do not use '$ErrorActionPreference = "SilentlyContinue";' because "" will be affected by '' wrapped around it
    script = '$ErrorActionPreference=[System.Management.Automation.ActionPreference]::SilentlyContinue; ' + " ".join(
